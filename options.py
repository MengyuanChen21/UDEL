...
parser.add_argument('--group_name', default='default', help='experiment group')
...
parser.add_argument("--alpha_edl", type=float, default=0.5)
parser.add_argument("--alpha_uct_guide", type=float, default=0.5)
parser.add_argument("--rat_atn", type=int, default=9)
parser.add_argument("--amplitude", type=float, default=0.3)
parser.add_argument("--mutual_weight", type=float, default=0.5)
parser.add_argument('--origin_ratio', type=float, default=0.7)
